...
def get_data() -> list:
    ...
    messages = list()
    messageGroups = list()
    for names in os.listdir('D:/Python/dataSet/') :
        with open('D:/Python/dataSet/' + names, newline = '', encoding = 'utf-8-sig') as csvfile:
...
data_train, data_test, data_train_label, data_test_label = train_test_split(data, labels, test_size=0.2, random_state=0)
...
y_train, y_test = data_train_label, data_test_label
